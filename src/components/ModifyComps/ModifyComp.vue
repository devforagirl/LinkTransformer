  ...
  <div class="ip2lCompBigBox">
    ...
    <div class="rightSideTop ip2lTopBox">
      ...
      <div class="ip2lBtnBox">
        <v-btn
          :disabled="vListDataModify.length==0"
          :depressed="vListDataModify.length==0"
...
export default {
  ...
  computed: {
    ...mapState(['arrayIPsCOPY', 'vListDataModify', 'flag_ip2lCmdBtn', 'strOutputToCopy']),
    ...
    modifyTextArea: {
      get() {
        return this.$store.state.modifyInput
      },

      set(strLinks) {
        this.$store.dispatch('handle_modifyInput', strLinks)
      }
    }
  },
  mounted() { },
